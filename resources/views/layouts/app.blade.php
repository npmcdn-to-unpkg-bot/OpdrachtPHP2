...
<head>
    ...
    <title>Location based garage sale</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/mijnstijl.css') }}" />
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/user/favorites') }}"><i class="fa fa-star"></i> Mijn favorieten</a></li>
                                <li><a href="{{ url('/messages') }}"><i class="fa fa-btn fa-comments-o"></i>Berichten</a></li>
